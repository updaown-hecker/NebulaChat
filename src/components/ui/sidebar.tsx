  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 relative h-full w-[--sidebar-width] bg-transparent transition-[width] ease-linear", // Changed: h-svh to h-full to respect parent
        ...
        <div
          className={cn(
            "duration-200 fixed bottom-0 top-16 z-10 hidden h-[calc(100svh_-_4rem)] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex", // MODIFIED HERE
            side === "left"
